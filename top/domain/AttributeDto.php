 ...
 *      fill in "aliexpress_attribute_name_id" and "aliexpress_attribute_value_id"(For multi-dropdown,
 *      splitting them into multiple elements)
 ...
 *      When encoutering this scenario, please fill in "aliexpress_attribute_name_id",
 *      "aliexpress_attribute_value_id" and "attribute_value".
 * 4). Besides the three types mentioned above, if the seller would like to fully customized all the atttributes,
